...
class CompanyController extends Controller
{
    ...
    public function checkSharing($input)
    {
         return DB::select("select subscriber where shareMe=:shareMe and subscriber=:subscriber limit 1",[
            "shareMe"=>$input["OtherSubscriber"],
    ...
    {
        $input=$request->all();
        return $this->sharingData($input);

    }
    public function sharingData($input)
    {
    ...
    public function viewShare($input){
...
SELECT
    ...
    MAX(u.subscriber) AS subscriber,
    MAX(u.name) AS name,
    MAX(u.companyName) AS companyName,
    MAX(m.created_at) AS created_at,
    MAX(m.uidCreator) AS uidOwner
FROM sharing m
INNER JOIN admins u ON m.shareMe = u.subscriber
    ...
    public function withdrawLongPromo(Request $request){
        ...
        if(Auth::check())
        {
            ...
            if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new PromotionController)->withdawPromo($input);
            }
            else{
                return response([
                    "status"=>false,
...
//my Acount
    ...
    public function stockCancelStock(Request $request){
        if(env('APP_VERS')===$request->input('app_vers'))
        {
        if(Auth::check())
        {
            ...
            if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new StockController)->stockCancelStock($input);
            }
            else{
                return response([
                    "status"=>false,
...
/*Request Stock */
    ...
    public function stockPayemtCancel(Request $request){
        if(env('APP_VERS')===$request->input('app_vers'))
        {
        if(Auth::check())
        {
            ...
            if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new StockController)->stockPayemtCancel($input);
            }
            else{
                return response([
                    "status"=>false,
 ...
 if($check)
    ...
    public function updateProducts(Request $request) {
        if(Auth::check())
        {
            ...
            if(Auth::user()->platform==$this->platform1)
            {
                ...
                if($input["actionStatus"]==="updatePrice")
                {

                      // $jsonData=json_decode(Auth::user()->permission,true);
                      $jsonData = json_decode(Auth::user()->permission, true) ?? [];
                       ...
                       $mypermission=$jsonData["editPrice"]??$editPriceTrue["editPrice"];
                   if($mypermission==="true")
                       {
    ...
    public function UseDefault(Request $request){
        ...
        if(Auth::check())
        {
            ...
            if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new AuthUserRegisterController)->UserDefault($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function checkDette(Request $request){
        if(env('APP_VERS')===$request->input('app_vers'))
        {
        ...
        if(Auth::check())
        {
            ...
            if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new StockController)->checkDette($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function reportSales(Request $request)
    {
        if(Auth::check())
        {
            ...
            if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new StockController)->reportSales($input);
            }
            else{
                return response([
                    "status"=>false,
...
//
    ...
    public function viewDeptDetails(Request $request){
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new StockController)->viewDeptDetails($input);
            }
            else{
                return response([
                    "status"=>false,
...
public function CompanySafariCalculate(Request $request){
   ...
   /*SafariCode end calculation */
    ...
    public function CompanyDeleteUserAssign(Request $request){
        if(env('APP_VERS')===$request->input('app_vers'))
        {
        if(Auth::check())
        {
            ...
            if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new AuthUserRegisterController)->UserDeleteByCompanyAssign($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function CompanyPromoget(Request $request){//add money to your country
        ...
        if(Auth::check())
        {
            ...
            {
                $input=$request->all();
                return (new PromotionController)->Promoget($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function CompanyCreatePromo(Request $request){//add money to your country
        if(env('APP_VERS')===$request->input('app_vers'))
        {
        ...
        if(Auth::check())
        {
            ...
            {
                $input=$request->all();
                return (new PromotionController)->CreatePromo($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function CompanyEditPromo(Request $request){//add money to your country
        if(env('APP_VERS')===$request->input('app_vers'))
        {
    ...
    public function CompanyDeletePromo(Request $request){//add money to your country
        if(env('APP_VERS')===$request->input('app_vers'))
        {
    ...
    public function CompanyPaidSuperAdmin(Request $request){//add money to your country
        if(env('APP_VERS')===$request->input('app_vers'))
        {
        ...
        if(Auth::check())
        {
            ...
            {
                $input=$request->all();
                return (new StockController)->paidSuperAdmin($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function CompanyAddPromo(Request $request){//add money to your country
        if(env('APP_VERS')===$request->input('app_vers'))
        {
        ...
        if(Auth::check())
        {
            ...
            {
                $input=$request->all();
                return (new StockController)->AddPromo($input);
            }
            else{
                return response([
                    "status"=>false,
