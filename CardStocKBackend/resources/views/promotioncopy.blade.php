...
//let promotionsData=[{"id": "promo_6R_1779021066", "name": "viva", "startDate": "2026-05-18 14:30", "endDate": "2026-05-20 14:30", "promotype": "quick", "promotion": {"amount": "100", "items": {"inStock": [{"productName": "mens cotton jacket", "qty": "1", "price": "0"}]}}, "condition": {"products": ["mens cotton jacket"], "exProducts": ["mens cotton jacket"], "TotalToCount": "cCount", "cartTotal": "500", "cartCount": "10", "card": "yes"}}, {"id": "promo_Zz_1779021110", "name": "kimda", "startDate": "2026-05-19 14:31", "endDate": "2026-05-19 14:31", "promotype": "quick", "promotion": {"amount": "100", "items": {"inStock": [{"productName": "mens casual slim fit", "qty": "1", "price": "0"}], "OutStock": []}}, "condition": {"allowProduct": "Only", "products": ["mens cotton jacket"], "exProducts": ["mens casual slim fit"], "TotalToCount": "cCount", "cartTotal": "500", "cartCount": "10", "card": "yes"}}];
let promotionsData=[];
...
if(data.status){//return data as true
    ...
    var promo=(Array.isArray(JSON.parse(data[0]["promoschema"])))?JSON.parse(data[0]["promoschema"]):[JSON.parse(data[0]["promoschema"])];
    //promotionsData=[JSON.parse(data[0]["promoschema"])];
    promotionsData=promo;
    mainPromoId=data[0]["uid"];
