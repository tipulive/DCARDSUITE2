( () => {
    ...
    function j(n) {
        let t = 0;
        for (; t < n.length && n.charAt(t) === "/"; )
            t++;
        return n.substring(t)
    }
    function _(n) {
        let t = n.length;
        for (; t > 0 && n.charAt(t - 1) === "/"; )
            t--;
    ...
    var v = class {
        ...
        async _loadWasmEntrypoint(t, i, r, e) {
            if (!this._scriptLoaded) {
                ...
                let d = (await import(c)).compileStreaming(fetch(o)), f;
...
Read more: https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts`),
    ...
    var S = class {
        async loadEntrypoint(t) {
            ...
            let s = new v;
            return s.setTrustedTypesPolicy(e.policy),
        ...
        async load({serviceWorkerSettings: t, onEntrypointLoaded: i, nonce: r, config: e}={}) {
            ...
            let h = new v;
            return h.setTrustedTypesPolicy(d.flutterTT.policy),
            this.didCreateEngineInitializer = h.didCreateEngineInitializer.bind(h),
            h.load(p, d, e, r, i)
        }
    }
    ;
...
_flutter.buildConfig = {
    "engineRevision": "18b71d647a292a980abb405ac7d16fe1f0b20434",
    "builds": [{
